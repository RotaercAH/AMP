            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px;">
                    <div class="card-header">
                        ...
                        <div class="modal fade" id="add-bot-btn" tabindex="-1" style="margin-top: 80px;">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr v-for="bot in bots" :key="bot.id">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-info" style = "margin-right: 10px;" data-bs-toggle='modal' :data-bs-target="'#update-bot-modal-' + bot.id">修改</button>
                                        <button type="button" class="btn btn-danger" @click="remove_bot(bot)">删除</button>

                                        <div class="modal fade" :id="'update-bot-modal-' + bot.id" tabindex="-1" style="margin-top: 80px;">
                                            <div class="modal-dialog modal-xl">
                                                <div class="modal-content">
                                                <div class="modal-header">
...
export default {
    ...
    setup() {
        ...
        const add_bot = () => {
            ...
            $.ajax({
                url: "https://app5706.acapp.acwing.com.cn/api/user/bot/add/",
                type: "POST",
                data:{
                    title: botadd.title,
        ...
        const remove_bot = (bot) => {
            $.ajax({
                url: "https://app5706.acapp.acwing.com.cn/api/user/bot/remove/",
                type: "POST",
                data:{
                    bot_id: bot.id,
                },
        ...
        const update_bot = (bot) => {
            botadd.error_message = "";
            $.ajax({
                url: "https://app5706.acapp.acwing.com.cn/api/user/bot/update/",
                type: "POST",
                data:{
                    bot_id: bot.id,
                    title: bot.title,
